...
export interface AddressInstance {
  ...
  getAddressTxs: (params: AddressParam | { address: string, after_txid?: string }) => Promise<Tx[]>;
  getAddressTxsChain: (params: AddressParam) => Promise<Tx[]>;
  getAddressTxsMempool: (params: AddressParam) => Promise<Tx[]>;
